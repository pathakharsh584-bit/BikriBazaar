...
<body id="adminBody">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // 1. Find the hamburger icon
            const menuIcon = document.querySelector('.fa-bars');
            
            // 2. Find the sidebar and main content areas
            const sidebar = document.querySelector('.sidebar');
            const mainContent = document.querySelector('.main-content');

            if (menuIcon && sidebar) {
                // Find the clickable wrapper around the icon
                const toggleBtn = menuIcon.closest('div, button, a') || menuIcon;
